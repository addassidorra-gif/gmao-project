...
SECRET_KEY = os.getenv("SECRET_KEY", "django-insecure-gmao-demo-key-change-me")
DEBUG = os.getenv("DEBUG", "True").lower() == "true"
ALLOWED_HOSTS = csv_env("ALLOWED_HOSTS", "127.0.0.1,localhost,testserver")
CSRF_TRUSTED_ORIGINS = csv_env("CSRF_TRUSTED_ORIGINS", "http://127.0.0.1:8000,http://localhost:8000")
